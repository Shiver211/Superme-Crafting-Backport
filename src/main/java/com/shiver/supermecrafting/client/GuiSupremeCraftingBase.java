...
public abstract class GuiSupremeCraftingBase extends GuiContainer {
    ...
    protected GuiSupremeCraftingBase(Container container) {
        super(container);
        this.xSize = 356;
    ...
    protected abstract void refreshCraftingResult();
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        fontRenderer.drawString(I18n.format(titleKey()), 8, 8, 4210752);
    }
