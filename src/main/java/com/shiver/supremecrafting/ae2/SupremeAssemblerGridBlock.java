...
public class SupremeAssemblerGridBlock implements IGridBlock {
    private final TileSupremeAssembler tile;

    public SupremeAssemblerGridBlock(TileSupremeAssembler tile) {
        this.tile = tile;
    }

    @Override public double getIdlePowerUsage() { return 0.0D; }
    ...
    public ItemStack getMachineRepresentation() {
        return new ItemStack(AE2Module.SUPREME_ASSEMBLER);
    }
}
