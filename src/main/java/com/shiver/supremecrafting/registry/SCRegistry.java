...
import com.shiver.supremecrafting.block.BlockSupremeFurnaceHatch;
import com.shiver.supremecrafting.block.BlockSupremeTable;
import com.shiver.supremecrafting.furnace.HatchRole;
import com.shiver.supremecrafting.furnace.TileFurnaceHatch;
import com.shiver.supremecrafting.item.ItemFurnaceDestroyer;
import com.shiver.supremecrafting.item.ItemSupremeFurnaceBomb;
import com.shiver.supremecrafting.item.ItemSupremeFurnaceTerminal;
import com.shiver.supremecrafting.item.ItemSupremeWrench;
...
public final class SCRegistry {
    ...
    private static void ae2(String methodName, Class<?>[] types, Object... args) {
        ...
        try {
            Class<?> bridge = Class.forName("com.shiver.supremecrafting.ae2.AE2RegistryBridge");
